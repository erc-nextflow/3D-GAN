...
class GAN3D(object):
    ...
    def build_architecture(self):
        ...
        if (self.model_name == 'architecture-D01'):

            return self.architecture01()

        if (self.model_name == 'architecture-D02'):

            return self.architecture02()

        if (self.model_name == 'architecture-D03'):

            return self.architecture03()

        if (self.model_name == 'architecture-D04'):
    ...
    def architecture01(self):
        ...
        prelu_1 = up_sampling_block(prelu_1, 3, 64, 1)
