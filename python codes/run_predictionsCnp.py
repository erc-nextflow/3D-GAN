...
def main():
    ...
    generator, discriminator, generator_loss, discriminator_loss = gan3d.architecture06()
    ...
    ckpt_file = f"{root_folder}/models/checkpoints_{model_name}/ckpt-20" #C04 ckpt-19    C05 ckpt-20 C06 ckpt-20
    ...
    fig, axs = plt.subplots(rows,cols, figsize=(fig_width, fig_height), squeeze=True)
...
class GAN3D(object):
    ...
    def __init__(self, model_name, nx, ny, nz, input_channels=3, output_channels=3, n_residual_blocks=56): #res blocks C05 48, C06 56, others 32
    ...
    def architecture05(self):
        ...
        for index in range(self.n_residual_blocks):
            ...
            if index == 8 or index == 16 or index == 24 or index == 32 or index == 40:
    ...
    def architecture06(self):
        ...
        for index in range(self.n_residual_blocks):
            ...
            if index == 10 or index == 20 or index == 30 or index == 40 or index == 50:
...
if __name__ == '__main__':
    ...
    epochs = 10
    learning_rate = 1e-4
    model_name = 'architecture-C06' #change model name -C04 -C05 -C06, architecture (line 33), checkpoint (line 52), number res. blocks (line 173)
    root_folder = '/    /'
