...
def main():
    ...
    generator, discriminator, generator_loss, discriminator_loss = gan3d.architecture05()
...
class GAN3D(object):
    ...
    def __init__(self, model_name, nx, ny, nz, input_channels=3, output_channels=3, n_residual_blocks=48):
    ...
    def build_architecture(self):
        ...
        if (self.model_name == 'architecture-C03'):

            return self.architecture03()

        if (self.model_name == 'architecture-C04'):

            return self.architecture04()

        if (self.model_name == 'architecture-C05'):

            return self.architecture05()

        if (self.model_name == 'architecture-C06'):

            return self.architecture06()
